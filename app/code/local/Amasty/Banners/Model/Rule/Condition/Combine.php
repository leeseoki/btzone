 ...
 */
class Amasty_Banners_Model_Rule_Condition_Combine extends Mage_Rule_Model_Condition_Combine
{
    ...
    public function getNewChildSelectOptions()
    {
        ...
        $conditions = array_merge_recursive($conditions, array(
            ...
            array('value'=> 'ambanners/rule_condition_combine', 'label'=>Mage::helper('salesrule')->__('Conditions combination')),
