 ...
 */
class Magestore_Megamenu_Block_Adminhtml_Megamenu_Edit_Tab_Content_Maincontent_Sku extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function __construct($arguments = array()) {
        ...
        $this->setTemplate('megamenu/widget/grid.phtml');
    }
    ...
    protected function _prepareColumns() {
        $this->addColumn('in_products', array(
            ...
            'index' => 'sku',
            'use_index' => true,
            'renderer' => 'megamenu/adminhtml_megamenu_edit_tab_content_maincontent_renderer_sku'
        ));
