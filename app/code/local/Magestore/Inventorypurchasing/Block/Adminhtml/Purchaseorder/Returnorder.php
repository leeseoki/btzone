 ...
 */
class Magestore_Inventorypurchasing_Block_Adminhtml_Purchaseorder_Returnorder extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            ...
            function uploadFile() {
               ...
               xhr.open('POST', '".$this->getUrl('inventorypurchasingadmin/adminhtml_purchaseorders/importproductforreturnorder')."');
               xhr.send(fd);              
           }
    ...
    public function getHeaderText()
    {
        if (Mage::registry('purchaseorder_data')
            ...
            return Mage::helper('inventorypurchasing')->__("Order Return For Purchase Order No. '%s'",
