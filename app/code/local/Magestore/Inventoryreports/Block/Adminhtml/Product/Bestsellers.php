 ...
 */
class Magestore_Inventoryreports_Block_Adminhtml_Product_Bestsellers extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {                
        $this->_controller = 'adminhtml_product_bestsellers';
        ...
        if(!$dateFrom || !$dateTo){
            ...
            $this->_headerText = Mage::helper('inventoryreports')->__('Product Bestsellers');        
        }
        parent::__construct();
