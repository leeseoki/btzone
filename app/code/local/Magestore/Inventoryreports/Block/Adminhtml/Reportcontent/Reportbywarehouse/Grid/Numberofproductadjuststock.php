...
//        Zend_Debug::dump($requestData);
        ...
        if(!$requestData['warehouse_select']){  //ALL WAREHOUSE
            ...
            ->join( array('adjust_product'=>'erp_inventory_adjuststock_product'), 'main_table.adjuststock_id = adjust_product.adjuststock_id', array('count(distinct adjust_product.product_id) as total_product', 'main_table.warehouse_name'))
            ...
            ->joinLeft(array('adjust'=>'erp_inventory_adjuststock'), 'main_table.adjuststock_id = adjust.adjuststock_id', array('main_table.product_id'))
...
//        return $this->getUrl('*/*/view', array('id' => $row->getId()));
    ...
    public function getGridUrl() {
        return $this->getUrl('*/adminhtml_report/numberofproductadjuststockgrid',array('top_filter'=>$this->getRequest()->getParam('top_filter')));
    }
