...
//        Zend_Debug::dump($requestData);
        ...
        if (!$requestData['warehouse_select']) {  //All Warehouses
            ...
            $collection->getSelect()
                    ->join(array('adjust_product' => 'erp_inventory_adjuststock_product'), 'main_table.adjuststock_id = adjust_product.adjuststock_id', array('SUM(adjust_product.adjust_qty) as total_adjust'))
            ...
            $collection->getSelect()
                    ->joinLeft(array('adjust' => 'erp_inventory_adjuststock'), 'main_table.adjuststock_id = adjust.adjuststock_id', array('SUM(main_table.adjust_qty) as total_adjust'))
...
//        return $this->getUrl('*/*/view', array('id' => $row->getId()));
    ...
    public function getGridUrl() {
        return $this->getUrl('*/adminhtml_report/totalqtyadjuststockgrid', array('top_filter' => $this->getRequest()->getParam('top_filter')));
    }
