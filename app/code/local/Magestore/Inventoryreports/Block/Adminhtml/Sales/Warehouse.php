 ...
 */
class Magestore_Inventoryreports_Block_Adminhtml_Sales_Warehouse extends Mage_Adminhtml_Block_Widget_Grid_Container
{
...
//        return 'inventory_report_sales_warehouse_grid';
//    }
//    
//    public function getChartName() {                  
//        return 'inventory_report_sales_warehouse_chart';
//    }
//    
//    public function getFilterUrl() {
//        $url = $this->getUrl('inventoryreportsadmin/adminhtml_sales/warehouse', array('key' => $this->getRequest()->getParam('key')));
//        return $url;
//    }
    
    public function __construct()
    {                
        $this->_controller = 'adminhtml_sales_warehouse';
